...
#ifdef CONFIG_ESP_BRIDGE_PROV_TRANSPORT_BLE
#include <wifi_provisioning/scheme_ble.h>
#endif /* CONFIG_ESP_BRIDGE_PROV_TRANSPORT_BLE */

#ifdef CONFIG_ESP_BRIDGE_PROV_TRANSPORT_SOFTAP
...
#if CONFIG_ESP_BRIDGE_PROV_SECURITY_VERSION_2
#if CONFIG_ESP_BRIDGE_PROV_SEC2_DEV_MODE
#define ESP_BRIDGE_PROV_SEC2_USERNAME          "wifiprov"
#define ESP_BRIDGE_PROV_SEC2_PWD               "abcd1234"
...
#ifdef CONFIG_ESP_BRIDGE_RESET_PROVISIONED
...
#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 0, 0)
#ifdef CONFIG_ESP_BRIDGE_PROV_SECURITY_VERSION_1
...
#else /* CONFIG_ESP_BRIDGE_PROV_TRANSPORT_SOFTAP */
